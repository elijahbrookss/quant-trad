...
test('Operations uses three task domains, canonical collector operations, and cursor-backed run history', () => {
  ...
  assert.match(console, /Live collector flow/)
  assert.match(console, /Precise fleet inventory/)
  assert.match(console, /Fact store/)
  assert.match(console, /No state is inferred in the browser/)
