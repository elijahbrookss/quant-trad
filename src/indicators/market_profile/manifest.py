...
MANIFEST = IndicatorManifest(
    ...
    params=(
        ...
        IndicatorParam(
            ...
            description="Minimum bars that must remain outside value after the raw breakout before a structural retest is eligible.",
    ...
    outputs=(
        ...
        IndicatorOutput(
            ...
            fields=("active_profile_key", "previous_location"),
        ),
        IndicatorOutput(
            name="balance_state",
            type="context",
