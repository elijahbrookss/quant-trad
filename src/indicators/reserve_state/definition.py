"""Reserve-state indicator definition contract."""
...
from .runtime import TypedReserveStateIndicator


class ReserveStateIndicator:
    NAME = MANIFEST.type
    MANIFEST = MANIFEST
    ...
    ) -> TypedReserveStateIndicator:
        _ = (
            resolved_params,
            strategy_indicator_metas,
            execution_context,
            source_facts,
        )
        return TypedReserveStateIndicator(
