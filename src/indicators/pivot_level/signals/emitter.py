...
from indicators.pivot_level.compute.engine import Level, PivotLevelIndicator
...
setattr(pivot_breakout_rule, "signal_id", _PIVOT_BREAKOUT_RULE_ID)
setattr(pivot_breakout_rule, "signal_label", "Breakout")
setattr(
    pivot_breakout_rule,
    "signal_description",
    "Detects when price closes beyond a pivot-derived level with confirmation.",
)
setattr(pivot_retest_rule, "signal_id", _PIVOT_RETEST_RULE_ID)
setattr(pivot_retest_rule, "signal_label", "Retest")
setattr(
    pivot_retest_rule,
    "signal_description",
