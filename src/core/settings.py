...
_ENV_BINDINGS: list[tuple[str, tuple[str, ...]]] = [
    ...
    ("QT_MARKET_DATA_LIFECYCLE_CANONICAL_HOT_DAYS", ("market_data_lifecycle", "canonical_retention", "hot_days")),
    ("QT_MARKET_DATA_LIFECYCLE_CANONICAL_HOT_DAYS_BY_FACT_TYPE", ("market_data_lifecycle", "canonical_retention", "hot_days_by_fact_type")),
    ("QT_MARKET_DATA_LIFECYCLE_CANONICAL_HOT_PAYLOAD_BUDGET_BYTES", ("market_data_lifecycle", "canonical_retention", "hot_payload_budget_bytes")),
    ("QT_MARKET_DATA_LIFECYCLE_CANONICAL_ARCHIVE_FILESYSTEM_BUDGET_BYTES", ("market_data_lifecycle", "canonical_retention", "archive_filesystem_budget_bytes")),
    ("QT_MARKET_DATA_LIFECYCLE_CANONICAL_ARCHIVE_MIN_FREE_BYTES", ("market_data_lifecycle", "canonical_retention", "archive_min_free_bytes")),
    ("QT_MARKET_DATA_LIFECYCLE_CANONICAL_MAX_CANDIDATE_PARTITIONS", ("market_data_lifecycle", "canonical_retention", "max_candidate_partitions")),
    ("QT_MARKET_DATA_LIFECYCLE_CANONICAL_MAX_INVENTORY_PARTITIONS", ("market_data_lifecycle", "canonical_retention", "max_inventory_partitions")),
    ("QT_MARKET_DATA_LIFECYCLE_CANONICAL_PLAN_STATEMENT_TIMEOUT_MS", ("market_data_lifecycle", "canonical_retention", "plan_statement_timeout_ms")),
    ("QT_MARKET_DATA_LIFECYCLE_CANONICAL_MAX_PLAN_SECONDS", ("market_data_lifecycle", "canonical_retention", "max_plan_seconds")),
    ("QT_MARKET_DATA_LIFECYCLE_CANONICAL_EXECUTION_ENABLED", ("market_data_lifecycle", "canonical_retention", "execution_enabled")),
    ("QT_MARKET_DATA_LIFECYCLE_CANONICAL_MAX_STEPS_PER_RUN", ("market_data_lifecycle", "canonical_retention", "max_steps_per_run")),
    ("QT_MARKET_DATA_LIFECYCLE_CANONICAL_MAX_RUN_SECONDS", ("market_data_lifecycle", "canonical_retention", "max_run_seconds")),
    ("QT_MARKET_DATA_LIFECYCLE_CANONICAL_EXECUTION_STATEMENT_TIMEOUT_MS", ("market_data_lifecycle", "canonical_retention", "execution_statement_timeout_ms")),
    ("QT_MARKET_DATA_LIFECYCLE_CANONICAL_MAX_PAGE_ROWS", ("market_data_lifecycle", "canonical_retention", "max_page_rows")),
    ("QT_MARKET_DATA_LIFECYCLE_CANONICAL_MAX_PAGE_LOGICAL_BYTES", ("market_data_lifecycle", "canonical_retention", "max_page_logical_bytes")),
    ("QT_MARKET_DATA_LIFECYCLE_CANONICAL_MAX_VERIFICATION_BYTES", ("market_data_lifecycle", "canonical_retention", "max_verification_bytes")),
    ("QT_MARKET_DATA_LIFECYCLE_CANONICAL_MAX_VERIFICATION_OBJECTS", ("market_data_lifecycle", "canonical_retention", "max_verification_objects")),
    ("QT_MARKET_DATA_LIFECYCLE_CANONICAL_MAX_VERIFICATION_PAGES", ("market_data_lifecycle", "canonical_retention", "max_verification_pages")),
