...
@pytest.mark.parametrize("fact_type", [
    "market.l2_book", "market.bbo", "market.depth_observation", "market.trade_flow",
    "market.trade_flow_feature", "market.derivative_state", "market.normalized.example", "unknown.family",
])
