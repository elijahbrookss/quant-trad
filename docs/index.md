...
- BTC PERP market-structure campaigns V1/V2: the historical source documents are
  unavailable in this repository. Their absence is retained as a lineage gap;
  [the V3 historical postmortem](research-campaigns/BTC_PERP_MARKET_STRUCTURE_CAMPAIGN_V3_DOSSIER.md)
  is the retained successor record and does not reconstruct V1 or V2.
